...
class Dislike extends Model
{
    ...
    /**
     * Compte le nombre de dislikes d'un message
     *
     * @param (int) $id_message
     * @return int nombre de dislikes
     */
    public function dislikeMessage($id_message): int
    {
        return $requete = $this->requete("SELECT * FROM $this->table WHERE id_message = $id_message")->rowcount();
    }

    /**
     * Compte le nombre de dislikes d'une conversation
     *
     * @param (int) $id_conversation
     * @return int nombre de dislikes
     */
    public function dislikeConversation($id_conversation): int
    {
        return $requete = $this->requete("SELECT * FROM $this->table WHERE id_conversation = $id_conversation")->rowcount();
    }
    
    /**
     * Compte le nombre de dislikes d'un utisateur dans un message
     *
     * @param (int) $id_utilisateur
     * @param (int) $id_message
     * @return (int) Nombre de dislikes d'un utilisateur dans un message
     */
    public function disLike($id_utilisateur, $id_message): int
    {
    ...
    /**
     * Supprime le dislike d'un utilisateur dans un message
     *
     * @param (int) $id_utilisateur
     * @param (int) $id_message
     * @return void
     */
    public function deleteDislike($id_utilisateur, $id_message): void
    {
